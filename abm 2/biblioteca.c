...
void inicializarProductos(eProducto listaProductos[],int tam)
{
    ...
    char nombre[10][50]={"infinia","axion power","V-Power","infinia Diesel","axion Diesel",
    "V-Power diesel","super","axion super","normal","kerosene"};
    int idProveedor[10]={1,2,3,1,2,3,1,2,3,1};
    char codigoDeBarra[10][50]={"122","222","322","422","522","622","722","822","922","962"};
    char fechaDeVencimiento[10][50]={"01/01/2020","01/02/2020","01/03/2020","01/04/2020",
    "01/05/2020","01/06/2020","01/07/2020","01/08/2020","01/09/2020","01/10/2020",};
...
void mostrarArrayProductosConProveedores(eProducto listaProducto[], int tamprod, eProveedor listaProveedores)
{
    ...
    for(i=0;i<tamprod;i++)
    {
        ...
        for(j=0;j<tamprov;j++)
        {
            if(listaProductos[i].idProveedor == listaProveedores[i].id)
